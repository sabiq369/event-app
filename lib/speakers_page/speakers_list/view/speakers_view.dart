...
import 'package:event_app/speakers_page/speakers_individual_page/view/speaker_individual_page.dart';
...
class SpeakersView extends StatelessWidget {
  SpeakersView({Key? key}) : super(key: key);
  final SpeakersController _speakersController = Get.put(SpeakersController());
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Obx(
                  () {
                    return _speakersController.isLoading.value
                        ? Center(
                            child: Padding(
                              padding:
                        ...
                        : _speakersController.speakersModel!.data.result.isEmpty
                            ? Image.asset('assets/images/empty-folder.png')
                            : ListView.builder(
                                itemCount: _speakersController
                                    .speakersModel!.data.result.length,
                                shrinkWrap: true,
                                physics: BouncingScrollPhysics(),
                                padding: EdgeInsets.only(bottom: 20),
                                itemBuilder: (context, index) {
                                  var speaker = _speakersController
                                  ...
                                  return ListTile(
                                    ...
                                    title: Column(
                                      ...
                                      children: [
                                        ...
                                        Html(data: speaker.speakerDesignation),
                                      ],
                                    ),
                                  );
                                },
