                  ...
                  children: [
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              elevation: 0,
                              backgroundColor: agendaController.button1.value
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              elevation: 0,
                              backgroundColor: agendaController.button2.value
                                  ? ColorConstants().toggleButtonColor
                                  : Colors.white),
                          child: Text(
                            'DAY 1 - SATURDAY\nAPRIL 20, 2024',
                    ...
                    Expanded(
                      child: ListView.builder(
                        itemCount:
                            agendaController.agendaModel!.data!.result.length,
                        shrinkWrap: true,
